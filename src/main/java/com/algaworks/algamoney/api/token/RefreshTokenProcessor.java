...
//Controle criado para tirar o refreshToken do corpo da reposta de solicitaçao de token
// por questao de melhor segurança
...
public class RefreshTokenProcessor implements ResponseBodyAdvice<OAuth2AccessToken>{
	...
	//Intercepta somente quando for do tipo postAccessToken
	@Override
